#!/usr/bin/env python3
"""
Tests for compareblocks.server

This file contains comprehensive tests for all functions in the compareblocks.server module.
...
import json
# from compareblocks.server import *


class TestServer:
    """Test class for compareblocks.server functions."""
