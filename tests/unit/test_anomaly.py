#!/usr/bin/env python3
"""
Comprehensive tests for anomaly functionality.
...
class TestAnomaly:
    """Comprehensive test class for anomaly functionality."""
    ...
    def test_anomalyfeatures_to_dict(self):
        """Test AnomalyFeatures.to_dict: Convert features to dictionary format."""
        try:
            ...
            if self.pdf_exists:
                ...
                # Testing AnomalyFeatures.to_dict with parameters: ['self']
