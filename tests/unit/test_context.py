#!/usr/bin/env python3
"""
Comprehensive tests for context functionality.
...
class TestContext:
    """Comprehensive test class for context functionality."""
    ...
    def test_contextfeatures_to_dict(self):
        """Test ContextFeatures.to_dict: Convert features to dictionary format."""
        try:
            ...
            if self.pdf_exists:
                ...
                # Testing ContextFeatures.to_dict with parameters: ['self']
