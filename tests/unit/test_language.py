#!/usr/bin/env python3
"""
Comprehensive tests for language functionality.
...
class TestLanguage:
    """Comprehensive test class for language functionality."""
    ...
    def test_languagefeatures_to_dict(self):
        """Test LanguageFeatures.to_dict: Convert features to dictionary format."""
        try:
            ...
            if self.pdf_exists:
                ...
                # Testing LanguageFeatures.to_dict with parameters: ['self']
