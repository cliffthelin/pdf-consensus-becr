...
class TestCore:
    """Comprehensive test class for core functionality."""
    ...
    def test_lengthfeatures_to_dict(self):
        """Test LengthFeatures.to_dict: Convert features to dictionary format."""
        try:
            ...
            if self.pdf_exists:
                ...
                # Testing LengthFeatures.to_dict with parameters: ['self']
