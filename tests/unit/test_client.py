#!/usr/bin/env python3
"""
Tests for compareblocks.client

This file contains comprehensive tests for all functions in the compareblocks.client module.
...
import json
# from compareblocks.client import *


class TestClient:
    """Test class for compareblocks.client functions."""
